// app/api/admin/products/[id]/stats/route.ts - Version sécurisée (ADMIN SEULEMENT)
...
export const GET = withAdminSecurity(async (
  ...
  try {
    ...
    console.log(`📊 Admin ${session.user.id} consulte les stats du produit ${productId}`)
    ...
    console.log(`✅ Admin accède aux stats du produit ${product.name}`)
